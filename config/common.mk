...
# Backup Tool
PRODUCT_COPY_FILES += \
    vendor/solar/prebuilt/common/bin/backuptool.sh:install/bin/backuptool.sh \
    vendor/solar/prebuilt/common/bin/backuptool.functions:install/bin/backuptool.functions \
    vendor/solar/prebuilt/common/bin/50-lineage.sh:system/addon.d/50-lineage.sh \
    vendor/solar/prebuilt/common/bin/blacklist:system/addon.d/blacklist

ifeq ($(AB_OTA_UPDATER),true)
PRODUCT_COPY_FILES += \
    vendor/solar/prebuilt/common/bin/backuptool_ab.sh:system/bin/backuptool_ab.sh \
    vendor/solar/prebuilt/common/bin/backuptool_ab.functions:system/bin/backuptool_ab.functions \
    vendor/solar/prebuilt/common/bin/backuptool_postinstall.sh:system/bin/backuptool_postinstall.sh
endif

# Backup Services whitelist
PRODUCT_COPY_FILES += \
    vendor/solar/config/permissions/backup.xml:system/etc/sysconfig/backup.xml

# Lineage-specific broadcast actions whitelist
PRODUCT_COPY_FILES += \
    vendor/solar/config/permissions/lineage-sysconfig.xml:system/etc/sysconfig/lineage-sysconfig.xml

# init.d support
PRODUCT_COPY_FILES += \
    vendor/solar/prebuilt/common/etc/init.d/00banner:system/etc/init.d/00banner \
    vendor/solar/prebuilt/common/bin/sysinit:system/bin/sysinit

ifneq ($(TARGET_BUILD_VARIANT),user)
# userinit support
PRODUCT_COPY_FILES += \
    vendor/solar/prebuilt/common/etc/init.d/90userinit:system/etc/init.d/90userinit
endif

# Copy all Lineage-specific init rc files
$(foreach f,$(wildcard vendor/solar/prebuilt/common/etc/init/*.rc),\
	$(eval PRODUCT_COPY_FILES += $(f):system/etc/init/$(notdir $f)))

# Copy over added mimetype supported in libcore.net.MimeUtils
PRODUCT_COPY_FILES += \
    vendor/solar/prebuilt/common/lib/content-types.properties:system/lib/content-types.properties
...
# This is Lineage!
PRODUCT_COPY_FILES += \
    vendor/solar/config/permissions/org.lineageos.android.xml:system/etc/permissions/org.lineageos.android.xml \
    vendor/solar/config/permissions/privapp-permissions-lineage.xml:system/etc/permissions/privapp-permissions-lineage.xml

# Hidden API whitelist
PRODUCT_COPY_FILES += \
    vendor/solar/config/permissions/lineage-hiddenapi-package-whitelist.xml:system/etc/permissions/lineage-hiddenapi-package-whitelist.xml

# Include Lineage audio files
include vendor/solar/config/lineage_audio.mk

ifneq ($(TARGET_DISABLE_LINEAGE_SDK), true)
# Lineage SDK
include vendor/solar/config/lineage_sdk_common.mk
endif

# TWRP
ifeq ($(WITH_TWRP),true)
include vendor/solar/config/twrp.mk
endif
...
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += vendor/solar/overlay
DEVICE_PACKAGE_OVERLAYS += vendor/solar/overlay/common
...
PRODUCT_EXTRA_RECOVERY_KEYS += \
    vendor/solar/build/target/product/security/lineage

-include vendor/solar-priv/keys/keys.mk
...
-include vendor/solar/config/partner_gms.mk
