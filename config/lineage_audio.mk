...
ALARM_PATH := vendor/solar/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/solar/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/solar/prebuilt/common/media/audio/ringtones
